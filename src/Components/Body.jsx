...
const Body = () => {
  return (
    <div className='space-y-4 lg:flex justify-between lg:px-7'>
      <div className='flex items-center justify-center lg:flex-1 lg:order-2 lg:justify-end'>
        <img src='./assets/Blue-Shape.svg' alt='1st' className='-rotate-[45deg] h-64 md:h-80 lg:h-[400px]'/>
      ...
      <div className='lg:flex-1 lg:order-1'>
        ...
        <form action='' className='flex flex-col gap-4 md:flex-row'>
          <input className='rounded-md px-4 py-3 placeholder:text-gray-400' type='email' placeholder='Enter email ID'/>
